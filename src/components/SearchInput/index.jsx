...
function SearchInput(props) {
    return (
        <div className={styles.root} >
            <svg className={styles.icon__search} enable-background="new 0 0 32 32" id="Glyph" version="1.1" viewBox="0 0 32 32">
            ...
            <input type="text" placeholder='find' className={styles.input__search} />
            <svg className={styles.icon__remove} data-name="Layer 1" height="200" id="Layer_1" viewBox="0 0 200 200" width="200">
